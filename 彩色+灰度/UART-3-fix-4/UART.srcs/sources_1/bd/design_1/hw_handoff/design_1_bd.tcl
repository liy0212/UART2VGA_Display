...
# module references:
# data_gen, rgb2gray, speed_select, uart_rx, uart_tx, vga_ctrl
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins data_gen_0/f_clk] [get_bd_pins rgb2gray_0/clk] [get_bd_pins speed_select_0/clk] [get_bd_pins uart_rx_0/i_clk_sys] [get_bd_pins uart_tx_0/i_clk_sys]
  ...
  connect_bd_net -net rgb2gray_0_oValid [get_bd_pins data_gen_0/pi_flag] [get_bd_pins rgb2gray_0/oValid]
  ...
  connect_bd_net -net uart_rx_0_dout_vld [get_bd_pins rgb2gray_0/iValid] [get_bd_pins uart_rx_0/dout_vld]
  connect_bd_net -net uart_rx_0_o_dout_b [get_bd_pins data_gen_0/pixel_b] [get_bd_pins rgb2gray_0/blue] [get_bd_pins uart_rx_0/o_dout_b]
  connect_bd_net -net uart_rx_0_o_dout_g [get_bd_pins data_gen_0/pixel_g] [get_bd_pins rgb2gray_0/green] [get_bd_pins uart_rx_0/o_dout_g]
  connect_bd_net -net uart_rx_0_o_dout_r [get_bd_pins data_gen_0/pixel_r] [get_bd_pins rgb2gray_0/red] [get_bd_pins uart_rx_0/o_dout_r]
  connect_bd_net -net uart_rx_0_o_uart_data [get_bd_pins data_gen_0/data_i] [get_bd_pins rgb2gray_0/gray]
  connect_bd_net -net uart_tx_0_o_uart_tx [get_bd_ports o_uart_tx] [get_bd_pins uart_tx_0/o_uart_tx]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins data_gen_0/rst_n] [get_bd_pins rgb2gray_0/rst_n] [get_bd_pins speed_select_0/rst_n] [get_bd_pins uart_rx_0/i_rst_n] [get_bd_pins uart_tx_0/i_rst_n] [get_bd_pins util_vector_logic_0/Res] [get_bd_pins vga_ctrl_0/rst_n]
